...
stories
	.add('Contained IconButtons', () => (
		<React.Fragment>
			<IconButton onPress={() => {}} name="star" size={20} color="red" />
			<IconButton onPress={() => {}} name="alarm" size={20} color="black" />
	...
	.add('Disabled IconButtons', () => (
		<React.Fragment>
			<IconButton onPress={() => {}} name="star" size={20} color="red" disabled />
			<IconButton onPress={() => {}} name="alarm" size={20} color="black" disabled />
			<IconButton onPress={() => {}} name="delete" size={20} color="black" disabled />
		</React.Fragment>
	));
